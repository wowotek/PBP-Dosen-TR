  ...
  <div class="container">
    <div class="row">
        ...
        <div class="col">
            <div class="grey-box-icon">
                <div class="icon-box-top grey-box-icon-pos">
                    <img src="{{asset('frontend/image/1misi.png')}}" alt="" />
                </div><!--icon box top -->
                <h4>1. Menjadikan pelajar yang berpendidikan baik dan berintelektual tinggi dalam kehidupan masyarakat.</h4>
                <h4>2. Meningkatkan jiwa santuy siswa di kehidupan sehari-hari guna menghindari ketegangan hidup.</h4>
                <h4>3. Berperan aktif serta ikut memiliki hobi rebahan di setiap harinya untuk mengistirahatkan badan dan pikiran.</h4>
            </div>
        </div><!--/span3-->
        <div class="col">
            <div class="grey-box-icon">
                <div class="icon-box-top grey-box-icon-pos">
                    <img src="{{asset('frontend/image/1sejarah.png')}}" alt="" />
                </div><!--icon box top -->
                <h4>
